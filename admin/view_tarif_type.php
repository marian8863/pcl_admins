        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Tarif Type  Detail
              <?php
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-3">
                    <a href="create_tarif_type" class="btn btn-primary btn-block"> + Add</a>
                ...
                <table id="example2"  class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    {                
                        $tt_id = $_GET['delete_id'];

                        $sql = "DELETE from tarif_type where tt_id = $tt_id";
